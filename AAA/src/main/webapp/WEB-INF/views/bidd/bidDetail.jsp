	...
	<div class="wrapper row3">
		...
		<div class="group">
			...
			<div class="two_third">
				...
				<h3 class="btmspace-80">남은 입찰 시간 :</h3>
				...
				<li class="one_third first">
					...
					<br /> <a href="#layer2" class="btn-example">딤처리 팝업레이어 1</a>
						<div class="dim-layer">
							<div class="dimBg"></div>
								...
								<div class="pop-container">
									<div class="pop-conts">
										...
										<p class="ctxt mb20">
											...
											successfully.<br> Selected invitees will be notified by
											e-mail on JANUARY 24th.<br>
					...
					<li class="one_third"><input type="button" value="입찰하기">
					</li>
