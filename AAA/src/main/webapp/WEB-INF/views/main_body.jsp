...
.info {position:relative;top:5px;left:5px;border-radius:6px;border: 1px solid #ccc;border-bottom:2px solid #ddd;font-size:12px;padding:5px;background:#902024c4;list-style:none;margin:0;} 
...
</p> <button onclick="removeCircles()">모두 지우기</button> 
    <ul id="category">
